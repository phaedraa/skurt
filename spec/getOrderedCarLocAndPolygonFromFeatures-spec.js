...
describe("getOrderedCarLocAndPolygonFromFeatures function", function() {
  var featuresPass = [
    {
      "type": "Feature",
      "geometry": {
  ...
  it('Swaps incorrectly ordered pairs', function() {
    var parsedFeatures = getOrderedCarLocAndPolygonFromFeatures(featuresSwitched);
    expect(parsedFeatures[0].geometry.type).toEqual('Point');
    expect(parsedFeatures[1].geometry.type).toEqual('Polygon');
  });
  ...
  it('Throw on invalid geometry type on first value', function() {
    expect(
      function () { getOrderedCarLocAndPolygonFromFeatures(featuresWrongType2) }
  ...
  var featuresInsufficientPolygonPoints = [
    ...
    }, 
    {
      ...
      "geometry": {
        "type": "Polygon",
        "coordinates": [[[-118.20327758789062,34.07143110146333],[-118.18748474121094,34.0213640496411]]]
      },
      "properties": {}
    }
  ];
  it('Throw on insufficient number of polygon points/edges', function() {
    expect(
      function () { getOrderedCarLocAndPolygonFromFeatures(featuresInsufficientPolygonPoints) }
  ...
  var featuresIncorrectCarLoc = [
    ...
    }, 
    {
      ...
      "geometry": {
        "type": "Polygon",
        "coordinates": [[[-118.20327758789062,34.07143110146333],[-118.18748474121094,34.0213640496411], [-118.18748474121094,34.0213640496411]]]
      },
      "properties": {}
    }
  ];
  it('Throw on invalid car location', function() {
    expect(
      function () { getOrderedCarLocAndPolygonFromFeatures(featuresIncorrectCarLoc) }
  ...
  it('Throw on empty features', function() {
    expect(
      function () { getOrderedCarLocAndPolygonFromFeatures(featuresEmpty) }
